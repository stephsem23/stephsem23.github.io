<?php
	// Your Email
	$recipient = "stephanie.semerville@gmail.com"; // PLEASE SET THE EMAIL ADDRESS of recipient
	$recipient_name = "FAMin"; // PLEASE SET THE NAME OF the email address holder
